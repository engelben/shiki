...
function createScanner(text, ignoreTrivia) {
  ...
  function scanNumber() {
    ...
    if (
      pos < text.length &&
      (text.charCodeAt(pos) === 69 /* E */ || text.charCodeAt(pos) === 101) /* e */
    ) {
      pos++
      if (
...
function toShikiTheme(rawTheme) {
  ...
  const shikiTheme = Object.assign(
    Object.assign({ name: rawTheme.name, type }, rawTheme),
...
function getThemeDefaultColors(theme) {
  ...
  const globalSetting = settings
    ...
    : undefined
  if (
    (_a = globalSetting === null || globalSetting === void 0 ? void 0 : globalSetting.settings) ===
      null || _a === void 0
      ? void 0
      : _a.foreground
  ) {
  ...
  if (
    (_b = globalSetting === null || globalSetting === void 0 ? void 0 : globalSetting.settings) ===
      null || _b === void 0
      ? void 0
      : _b.background
  ) {
  ...
  if (
    !fg &&
    ((_d = (_c = theme) === null || _c === void 0 ? void 0 : _c.colors) === null || _d === void 0
      ? void 0
      : _d['editor.foreground'])
  ) {
    fg = theme.colors['editor.foreground']
  }
  if (
    !bg &&
    ((_f = (_e = theme) === null || _e === void 0 ? void 0 : _e.colors) === null || _f === void 0
      ? void 0
      : _f['editor.background'])
  ) {
...
function resolveLang(lang) {
  return typeof lang === 'string'
    ? languages.find(l => {
        var _a
        return (
          l.id === lang || ((_a = l.aliases) === null || _a === void 0 ? void 0 : _a.includes(lang))
        )
      })
    : lang
}
